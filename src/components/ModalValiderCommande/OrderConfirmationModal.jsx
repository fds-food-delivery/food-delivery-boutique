...
const OrderConfirmationModal = ({
	...
	const validateForm = () => {
		...
		if (!TypePaiement.some((payment) => payment.name === selectedPayment)) {
			...
			<Modal.Body className="modal-body">
				...
				>
					...
					{errors.selectedPayment && (
						<small className="text-danger">{errors.selectedPayment}</small>
					)}
					<p className="mb-4"></p>

					<div className="form-grou">
						Montant Total a payer :
						<span className="text-success">{totalPrice()} FCFA</span>
					</div>
