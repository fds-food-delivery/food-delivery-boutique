            ...
            <nav className="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    <a href="#" className="flex items-center">
                        ...
                        <img src={assets.logo} className="h-6 mr-3 sm:h-9"
                             alt="Landwind Logo"/>
                    </a>
                    ...
                    <div
                        ...
                        lg:space-y-0 dark:text-gray-400 dark:hover:text-white dark:border-gray-700
                        ...
                        <div
                            className="
                            flex items-center justify-between w-full lg:w-auto lg:order-2 lg:ml-4 lg:space-x-8 dark:text-gray-400 dark:hover:text-white dark:border-gray-700">
                            {/*react icon search*/}
                            <FaSearch
                                size={50}
                                cursor={"pointer"}
                            ...
                            />
                            <CartIconWithCount itemCount={15}/>
                            <FaUser size={50} color="#f86c6b"
                                    className="text-red-500 text-5xl hover:text-red-700 hover:shadow-lg transition duration-300 ease-in-out"/>
                        </div>
                    </div>
                </div>
            </nav>
            {/* Script pour Flowbite, si nécessaire dans votre projet React */}
