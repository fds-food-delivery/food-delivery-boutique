...
const APropos = () => {
	return (
		<div className="apropos-container mt-5 pt-5 relative bg-cover bg-center">
			...
			<div className="apropos-content relative max-w-4xl mx-auto p-8 bg-white bg-opacity-90 rounded-lg shadow-lg">
				...
				<div className="text-lg text-gray-700 space-y-6">
					<p>
						...
						rapprocher les gens. Fondé en 2xxx, notre fast-food a été créé avec
						la vision de proposer des repas délicieux, rapides, et abordables
						pour tous.
					</p>
					<p>
						Notre menu est soigneusement conçu pour offrir une variété de plats
						savoureux, des burgers juteux aux salades fraîches, en passant par
						nos célèbres frites croustillantes. Nous utilisons uniquement des
						ingrédients de qualité, sourcés auprès de fournisseurs locaux de
						confiance.
					</p>
					{/* Tableau du menu */}
					...
					<p>
						Merci de faire partie de notre histoire. Nous sommes impatients de
						continuer à vous servir et à grandir avec vous.
					</p>
				</div>
			</div>
		</div>
